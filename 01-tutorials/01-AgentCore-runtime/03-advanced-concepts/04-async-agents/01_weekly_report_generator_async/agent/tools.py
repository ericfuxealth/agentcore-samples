...
S3_BUCKET = 'xealth-372080370602-agentcore-deep-dive'  # Will be updated by update_demo_dates.py
S3_PREFIX = 'weekly_report_generator_async/upload'
DEMO_DATA_PREFIX = 'weekly_report_generator_async/demo_data'  # S3 prefix for demo data
